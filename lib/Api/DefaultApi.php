...
class DefaultApi
{
     ...
     * DeleteTour
     *
     * @param  string $source_id Use source id to delete tours (required)
     * @param  string $project Use this property to specify project (required)
     ...
     * @return \InfocenterUpdate\Client\Model\DsUpdateResponse
     */
    public function deleteTour($source_id, $project, $ocp_apim_subscription_key)
    {
        list($response) = $this->deleteTourWithHttpInfo($source_id, $project, $ocp_apim_subscription_key);
        return $response;
    }
     ...
     * @return array of \InfocenterUpdate\Client\Model\DsUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteTourWithHttpInfo($source_id, $project, $ocp_apim_subscription_key)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->deleteTourRequest($source_id, $project, $ocp_apim_subscription_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTourAsync($source_id, $project, $ocp_apim_subscription_key)
    {
        return $this->deleteTourAsyncWithHttpInfo($source_id, $project, $ocp_apim_subscription_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTourAsyncWithHttpInfo($source_id, $project, $ocp_apim_subscription_key)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->deleteTourRequest($source_id, $project, $ocp_apim_subscription_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteTourRequest($source_id, $project, $ocp_apim_subscription_key)
    {
        // verify the required parameter 'source_id' is set
        if ($source_id === null || (is_array($source_id) && count($source_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \InfocenterUpdate\Client\Model\DsUpdateResponse
     */
    public function postUpsertTour($ocp_apim_subscription_key, $project, $body = null)
    {
        list($response) = $this->postUpsertTourWithHttpInfo($ocp_apim_subscription_key, $project, $body);
        return $response;
    }

    /**
     * Operation postUpsertTourWithHttpInfo
     *
     * PostUpsertTour
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     ...
     * @return array of \InfocenterUpdate\Client\Model\DsUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUpsertTourWithHttpInfo($ocp_apim_subscription_key, $project, $body = null)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->postUpsertTourRequest($ocp_apim_subscription_key, $project, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertTourAsync($ocp_apim_subscription_key, $project, $body = null)
    {
        return $this->postUpsertTourAsyncWithHttpInfo($ocp_apim_subscription_key, $project, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postUpsertTourAsyncWithHttpInfo
     *
     * PostUpsertTour
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertTourAsyncWithHttpInfo($ocp_apim_subscription_key, $project, $body = null)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->postUpsertTourRequest($ocp_apim_subscription_key, $project, $body);
    ...
    /**
     * Create request for operation 'postUpsertTour'
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     * @param  string $project Use this property to specify project (required)
     * @param  \InfocenterUpdate\Client\Model\DsTourRequest $body (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUpsertTourRequest($ocp_apim_subscription_key, $project, $body = null)
    {
        // verify the required parameter 'ocp_apim_subscription_key' is set
        if ($ocp_apim_subscription_key === null || (is_array($ocp_apim_subscription_key) && count($ocp_apim_subscription_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ocp_apim_subscription_key when calling postUpsertTour'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling postUpsertTour'
            );
        }
     ...
     * @return \InfocenterUpdate\Client\Model\DsUpdateResponse
     */
    public function putUpsertTour($ocp_apim_subscription_key, $project, $body = null)
    {
        list($response) = $this->putUpsertTourWithHttpInfo($ocp_apim_subscription_key, $project, $body);
        return $response;
    }

    /**
     * Operation putUpsertTourWithHttpInfo
     *
     * PutUpsertTour
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     ...
     * @return array of \InfocenterUpdate\Client\Model\DsUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function putUpsertTourWithHttpInfo($ocp_apim_subscription_key, $project, $body = null)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->putUpsertTourRequest($ocp_apim_subscription_key, $project, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putUpsertTourAsync($ocp_apim_subscription_key, $project, $body = null)
    {
        return $this->putUpsertTourAsyncWithHttpInfo($ocp_apim_subscription_key, $project, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putUpsertTourAsyncWithHttpInfo
     *
     * PutUpsertTour
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putUpsertTourAsyncWithHttpInfo($ocp_apim_subscription_key, $project, $body = null)
    {
        $returnType = '\InfocenterUpdate\Client\Model\DsUpdateResponse';
        $request = $this->putUpsertTourRequest($ocp_apim_subscription_key, $project, $body);
    ...
    /**
     * Create request for operation 'putUpsertTour'
     *
     * @param  string $ocp_apim_subscription_key Subscription key to access the api. Get it on developer.discover.swiss. (required)
     * @param  string $project Use this property to specify project (required)
     * @param  \InfocenterUpdate\Client\Model\DsTourRequest $body (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putUpsertTourRequest($ocp_apim_subscription_key, $project, $body = null)
    {
        // verify the required parameter 'ocp_apim_subscription_key' is set
        if ($ocp_apim_subscription_key === null || (is_array($ocp_apim_subscription_key) && count($ocp_apim_subscription_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ocp_apim_subscription_key when calling putUpsertTour'
            );
        }
        // verify the required parameter 'project' is set
        if ($project === null || (is_array($project) && count($project) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project when calling putUpsertTour'
            );
        }
